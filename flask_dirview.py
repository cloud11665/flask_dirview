...
proglang_exts = {
  "j","php3","di","sagews","xmi","ada","bmx","glslv","cpy","sublime-menu","f08",
  "ascx","d-objdump","mkiv","inc","nb","plt","fcgi","x3d","tf","2","ttl","jsfl",
  "rbfrm","xc","dylan","boot","capnp","zep","xq","w","h","http","styl","lvproj",
  "gms","icl","sage","pm","axi","f","idc","lds","mir","3m","fsproj","bzl","clp",
  "lbx","sci","aux","p6","sublime-settings","cfg","edn","sch","sublime-snippet",
  "ftl","fcgi","rq","plot","cs","cbl","vhdl","sj","prw","applescript","command",
  "gtpl","erl","tex","mata","rbtbar","dll.config","launch","xrl","lasso9","inc",
  "ccxml","dlm","ML","fan","emberscript","cirru","ly","rest.txt","com","eclass",
  "prc","m","reb","sp","inc","vhd","sublime-macro","anim","cw","grt","xml.dist",
  "oxygene","xproc","rake","ld","apib","kt","sql","mathematica","prg","hpp","h",
  "psd1","hxx","rpy","rest","ivy","flux","xsp-config","4th","numsc","sc","slim",
  "sma","mm","bison","r","prefab","sql","cljx","nginxconf","cl","cls","fs","tu",
  "mk","l","bf","fs","pd_lua","a51","ant","vhf","t","wsgi","xml","dpatch","wxi",
  "gyp","omgrofl","hbs","ma","_ls","meta","brd","lisp","fsx","wisp","cpp","fun",
  "inc","3","gcode","sc","gradle","sig","vsh","aj","vapi","ex","vcxproj","xslt",
  "reds","robot","svg","pd","cxx-objdump","vhost","ihlp","l","qml","lidr","eex",
  "ec","sl","jsb","rs.in","jflex","do","pod","sublime-completions","scd","pyde",
  "ur","pyw","fxh","vhost","h","stTheme","rsx","moo","sublime-workspace","hxsl",
  "gs","wlua","gv","sublime-commands","vert","csproj","lgt","cobol","txt","mod",
  "ml4","clw","mkdn","markdown","jl","druby","yacc","nl","zsh","em","asp","xul",
  "adb","ssjs","shen","sparql","ksh","mmk","csv","db2","adoc","ctp","toc","psc",
  "dart","pl","gp","hy","cppobjdump","eliomi","cake","pan","epj","vim","thrift",
  "jade","aw","xquery","ss","xproj","vue","auk","fancypack","scss","decls","ll",
  "desktop","pde","f03","moon","stan","fs","pluginspec","lock","arc","nse","rs",
  "m4","pogo","exs","lasso8","xs","xlf","f","podspec","js","tpl","ph","es","gd",
  "inc","ijs","cljs.hl","7","ahkl","x10","sexp","handlebars","awk","cl2","asmx",
  "vark","jsproj","t","hats","xojo_script","f95","plb","vssettings","cmd","mcr",
  "mm","ux","mss","csx","md","textile","mkvi","erb.deface","xsjs","pac","plist",
  "wl","nsh","5","phps","cats","xhtml","sublime-theme","fsi","phpt","cfm","jsp",
  "builder","css","nbp","scala","asc","m","dats","weechatlog","frt","pck","oxh",
  "sls","me","yml","groovy","cr","vshader","tsx","iml","storyboard","cbx","chs",
  "upc","maxproj","creole","tab","metal","uno","hcl","coffee","pike","cson","m",
  "rktd","muf","las","topojson","ms","sty","pytb","fr","kicad_pcb","hlean","gs",
  "axs.erb","volt","d","haml","emacs.desktop","rg","pro","inc","myt","uc","gml",
  "sls","pub","nit","nim","ltx","lpr","fcgi","mkdown","urdf","oxo","rpy","fcgi",
  "sqf","php4","rebol","sublime-project","bats","cgi","jq","purs","latte","asd",
  "kml","syntax","lol","tml","tst","psc1","ccp","cu","clj","go","pks","vrx","x",
  "gshader","gsx","_js","oz","mod","webidl","ml","als","txl","c-objdump","frag",
  "tst","ni","rmd","agda","lsp","mkii","ceylon","kts","cs","irbrc","reek","vhs",
  "numpy","java","mustache","fcgi","vb","mkd","sublime_session","xpl","gd","1m",
  "monkey","cgi","pro","logtalk","smt","graphql","cmake","fcgi","opencl","wsdl",
  "gsp","ps1xml","j","bones","bib","xi","cake","ncl","gml","glsl","kid","swift",
  "nsi","pir","ooc","raml","m4","filters","ch","xsl","nut","cgi","jsx","irclog",
  "pp","haml.deface","for","aug","ninja","jss","targets","cdf","mxt","jbuilder",
  "lsl","as","pwn","phtml","po","scxml","m","sce","gnu","vba","cp","rno","html",
  "pkl","d","hh","xsd","nproj","wsf","psm1","chpl","geom","lhs","i7x","cy","gi",
  "sjs","pb","cql","wlt","fr","bf","props","inc","xqm","tcsh","mat","litcoffee",
  "nu","golo","1in","fshader","pro","yaml","ps1","t","1x","psgi","adp","numpyw",
  "org","lex","yaml-tmlanguage","ecl","inl","ct","pov","ui","xojo_report","sml",
  "mtml","cls","xpy","ahk","rviz","m","kit","cls","rd","jsm","plsql","eh","god",
  "nqp","ily","pl6","pl","asset","ecl","xm","mod","mly","pluginspec","apl","nl",
  "zone","odd","6","geojson","cps","intr","vhi","ado","l","ebuild","asax","h++",
  "tm","rbbas","asc","lisp","dita","arpa","php5","mt","jsonld","ron","f77","nb",
  "frg","dpr","srdf","rdoc","matah","mspec","gnuplot","ini","tool","9","shader",
  "pas","dotsettings","gml","mdpolicy","unity","xsjslib","ipf","iss","pp","rdf",
  "xib","b","grxml","befunge","thy","htm","al","ik","flex","svh","rst","no","b",
  "csl","ashx","xojo_window","hqf","rbmnu","cl","asciidoc","scrbl","bro","yang",
  "r2","geo","fp","rst.txt","c++-objdump","sublime-keymap","nlogo","pm","mirah",
  "mxml","t","elm","pasm","sh","eclxml","pyp","mao","3in","m","ls","hx","mumps",
  "g","ampl","nuspec","pl","darcspatch","hh","dyalog","cmake.in","nimrod","sch",
  "n","E","ditamap","lookml","wiki","gco","bsv","frm","rbx","vho","cpp-objdump",
  "for","vbproj","p","wxl","ipynb","dyl","podsl","tcl","red","mask","vbs","sbt",
  "raw","pig","jscad","tcc","gemspec","pyx","plx","viw","sublime_metrics","6pl",
  "rb","d","v","thor","mli","tac","y","php","ncl","ddl","3x","sv","rl","mkfile",
  "duby","erb","_coffee","xsp.metadata","prolog","lslp","eps","p6m","cfc","tpp",
  "sh-session","qbs","wxs","gawk","moo","doh","ins","io","bas","sublime-syntax",
  "watchr","cxx","feature","cljs","xojo_menu","cc","fish","mawk","bb","s","6pm",
  "mo","smt2","pt","urs","dcl","zpl","ino","au3","bat","vhw","g","zcml","jinja",
  "fy","fsh","tmux","pat","self","cl","ps","tmSnippet","nix","sql","bbx","abap",
  "ts","xql","twig","mll","pxi","grace","krl","emacs","cfml","jake","f90","boo",
  "es6","hs","rktl","st","r3","ts","xht","dtx","ck","xqy","es","cshtml","json5",
  "clixml","sass","perl","lean","mu","ch","parrot","vcl","cproject","sql","inc",
  "sthlp","factor","rbuild","gap","ms","rbxs","xacro","vxml","veo","tsx","ston",
  "8","escript","pm6","php","rbres","ditaval","roff","fpp","desktop.in","patch",
  "djs","rhtml","l","axs","pxd","4","cuh","dfm","json","pony","sld","cljc","fx",
  "p6l","e","r","ls","fth","click","ktm","ru","forth","tmTheme","eam.fs","vala",
  "rsh","hlsli","minid","man","hsc","st","less","zimpl","v","m","pyt","html.hl",
  "rbw","sats","lid","n","brd","mediawiki","asc","vht","pbi","lmi","csh","ldml",
  "mako","tmPreferences","asm","owl","dot","cjsx","c++","fr","opal","xaml","el",
  "xtend","zmpl","fs","properties","rkt","iced","ox","hlsl","g4","smali","ruby",
  "mod","hrl","xliff","glade","scm","sas","rabl","eliom","liquid","lua","lagda",
  "proto","hic","fx","pmod","1","cls","tmLanguage","nawk","ms","toml","c","opa",
  "dockerfile","fxml","maxhelp","pro","ash","udf","c++objdump","gvy","brs","vh",
  "apacheconf","scaml","gst","hb","frx","sps","frag","matlab","vbhtml","cljscm",
  "maxpat","tmCommand","gf","cp","nc","lfe","njs","bash","nasm","osm","py","dm",
  "xojo_toolbar","ny","scad","diff","cob","aspx","ads","rs","mak","jelly","inc",
  "bb","pot","axml","sh.in","tea","axd","for","pkb","pls","axi.erb","ipp","yap",
  "sublime-mousemap","mms","objdump","sublime-build","scpt","lasso","3qt","idr",
  "spin","rss","coq","yy","pri","rbuistate","lsp","glf","yrl","xojo_code","pod",
  "prefs",}
